      ...
      v = function v(a, b) {
        ...
        C = /^.[^:#\[\.,]*$/; function D(a, b, c) {
          ...
          G = r.fn.init = function (a, b, c) {
            ...
            I = { children: !0, contents: !0, next: !0, prev: !0 }; r.fn.extend({
              has: function has(a) {
                var b = r(a, this),
                  ...
                  ca = function ca(a, b, c, d) {
                    ...
                    ka = { option: [1, "<select multiple='multiple'>", "</select>"], thead: [1, "<table>", "</table>"], col: [2, "<table><colgroup>", "</colgroup></table>"], tr: [2, "<table><tbody>", "</tbody></table>"], td: [3, "<table><tbody><tr>", "</tr></tbody></table>"], _default: [0, "", ""] }; ka.optgroup = ka.option, ka.tbody = ka.tfoot = ka.colgroup = ka.caption = ka.thead, ka.th = ka.td; function la(a, b) {
                      ...
                      sa = /^([^.]*)(?:\.(.+)|)/; function ta() {
                        ...
                        constructor: r.Event, isDefaultPrevented: ua, isPropagationStopped: ua, isImmediatePropagationStopped: ua, isSimulated: !1, preventDefault: function preventDefault() {
                        ...
                        Ba = /^\s*<!(?:\[CDATA\[|--)|(?:\]\]|--)>\s*$/g; function Ca(a, b) {
                          ...
                          La = function La(b) {
                            ...
                            Sa = d.createElement("div").style; function Ta(a) {
                              ...
                              constructor: Xa, init: function init(a, b, c, d, e, f) {
                            ...
                            }, r.fx = Xa.prototype.init, r.fx.step = {}; var Ya,
                              Za,
                              $a = /^(?:toggle|show|hide)$/,
                              _a = /queueHooks$/; function ab() {
                                ...
                                var d,
                                  ...
                                  j = h.promise({
                                    elem: a, props: r.extend({}, b), opts: r.extend(!0, { specialEasing: {}, easing: r.easing._default }, c), originalProperties: b, originalOptions: c, startTime: Ya || bb(), duration: c.duration, tweens: [], createTween: function createTween(b, c) {
                                ...
                                ib = r.expr.attrHandle; r.fn.extend({
                                        ...
                                        wb = /^(?:input|select|textarea|keygen)/i; function xb(a, b, c, d) {
                                          ...
                                          Ib = d.createElement("a"); Ib.href = qb.href; function Jb(a) {
                                            ...
                                            Pb = r.ajaxSettings.xhr(); o.cors = !!Pb && "withCredentials" in Pb, o.ajax = Pb = !!Pb, r.ajaxTransport(function (b) {
                                              var _c, d; return o.cors || Pb && !b.crossDomain ? {
...
!function (a, b, c, d) {
  function e(b, c) {
    ...
    var d; return this.options.responsiveBaseElement !== b ? d = a(this.options.responsiveBaseElement).width() : b.innerWidth ? d = b.innerWidth : c.documentElement && c.documentElement.clientWidth ? d = c.documentElement.clientWidth : console.warn("No se puede detectar el ancho de la ventana gráfica."), d;
  ...
  var e = function e(c) {
    ...
    }, this._core.options = a.extend({}, e.Defaults, this._core.options), this._core.$element.on(this._handlers), this._intervalId = null; var d = this; a(b).on("load", function () {
  ...
  var e = function e(b) {
    ...
    var d,
      ...
      }; if (b.wrap(a("<div/>", { class: "owl-video-wrapper", style: g })), this._core.settings.lazyLoad && (i = "data-src", j = "owl-lazy"), h.length) return l(h.attr(i)), h.remove(), !1; "youtube" === c.type ? (f = "//img.youtube.com/vi/" + c.id + "/hqdefault.jpg", l(f)) : "vimeo" === c.type ? a.ajax({
        type: "GET", url: "//vimeo.com/api/v2/video/" + c.id + ".json", jsonp: "callback", dataType: "jsonp", success: function success(a) {
          f = a[0].thumbnail_large, l(f);
        }
      }) : "vzaar" === c.type && a.ajax({
        type: "GET", url: "//vzaar.com/api/videos/" + c.id + ".json", jsonp: "callback", dataType: "jsonp", success: function success(a) {
                  ...
                  c = [t.animatedClassName].concat(r ? r.split(" ") : []).filter(function (e) {
                    ...
                    in: function (e, t, n) {
                      var o = window.innerHeight,
                        ...
                        c = a || n,
                        s = e; i && document.querySelectorAll(i) && (s = document.querySelectorAll(i)[0]); var u = Z(s).top - o; switch (c) {
                          case "top-bottom":
...
!function (t, e) {
  ...
  return function (t) {
    ...
    n.r(e), n.d(e, "default", function () {
      ...
      } var e, n, i; return e = t, (n = [{
        key: "setViewportTop", value: function value(t) {
